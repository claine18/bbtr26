document.addEventListener('DOMContentLoaded', function () {
  ...
  var T = {
    en: {
      ...
      savedYes: '🥰🥰🥰🥰🥰 Cant wait !!!!!',
      staffLabel: '👯‍♀️ Do you want to be STAFF and help us set-up/cleaning for a few days before and after? Discounted tickets and slay T-shirts',
    ...
    fr: {
     ...
     stationHref: 'https://www.sncf-connect.com/train/france/nouvelle-aquitaine/ychoux',
      ...
      savedYes: '🥰🥰🥰🥰🥰 Cant wait !!!!!',
      staffLabel: "👯‍♀️ Veux tu etre membre du STAFF et nous aider au montage/rangement avant et aprés le week-end? Ticket à tarifs réduits et T-shirts qui slay ",
